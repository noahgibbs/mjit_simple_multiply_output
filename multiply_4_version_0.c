...
ALWAYS_INLINE(static VALUE _mjit_inlined_10(rb_execution_context_t *ec, rb_control_frame_t *reg_cfp, const VALUE orig_self, const rb_iseq_t *original_iseq));
static inline VALUE
_mjit_inlined_10(rb_execution_context_t *ec, rb_control_frame_t *reg_cfp, const VALUE orig_self, const rb_iseq_t *original_iseq)
{
    const VALUE *orig_pc = reg_cfp->pc;
    const VALUE *orig_sp = reg_cfp->sp;
    VALUE stack[2];
    static const VALUE *const original_body_iseq = (VALUE *)0x7fcf47764f80;
...
label_4: /* opt_mult */
{
    ...
    ci = (CALL_INFO)0x7fcf477680c0;
    cc = (CALL_CACHE)0x7fcf47765010;
    recv = stack[0];
    obj = stack[1];
    {
...
label_9: /* opt_mult */
{
    ...
    MAYBE_UNUSED(CALL_INFO) ci;
    MAYBE_UNUSED(VALUE) obj, recv, val;
    ci = (CALL_INFO)0x7fcf477680d0;
    cc = (CALL_CACHE)0x7fcf47765038;
    recv = stack[0];
    obj = stack[1];
    {
        val = vm_opt_mult(recv, obj);
...
label_14: /* opt_mult */
{
    ...
    MAYBE_UNUSED(CALL_INFO) ci;
    MAYBE_UNUSED(VALUE) obj, recv, val;
    ci = (CALL_INFO)0x7fcf477680e0;
    cc = (CALL_CACHE)0x7fcf47765060;
    recv = stack[0];
    obj = stack[1];
    {
        val = vm_opt_mult(recv, obj);
        ...
        if (val == Qundef) {
            reg_cfp->sp = vm_base_ptr(reg_cfp) + 2;
            reg_cfp->pc = original_body_iseq + 14;
            RB_DEBUG_COUNTER_INC(mjit_cancel_opt_insn);
            goto cancel;
        }
    }
    ...
    *(reg_cfp->sp + -1) = stack[4];
    {
        ...
        stack[0] = _mjit_inlined_10(ec, reg_cfp, orig_self, original_iseq);
        reg_cfp->self = orig_self;
    }
}
