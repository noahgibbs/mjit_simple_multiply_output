...
{
    VALUE stack[3];
    static const rb_iseq_t *original_iseq = 0x7ff4cd930b88;
    static const VALUE *const original_body_iseq = (VALUE *)0x7ff4cd506fb0;
...
label_6: /* opt_send_without_block */
{
    ...
    if (UNLIKELY(GET_GLOBAL_METHOD_STATE() != 143 ||
        ...
        reg_cfp->sp = vm_base_ptr(reg_cfp) + 3;
        goto send_cancel;
    }
    reg_cfp->pc = original_body_iseq + 9;
    reg_cfp->sp = vm_base_ptr(reg_cfp) + 3;
    *(reg_cfp->sp + -3) = stack[0];
